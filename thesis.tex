...
%%%%%  DEFAULT  %%%%%
%%%%%%%%%%%%%%%%%%%%%
\providecommand{\chooselayout}{\documentclass[12pt,lot,lof,twoside,longbibliography,nofootinbib,preprintnumbers]{puthesis}}
...
\makeatletter
\hypersetup{bookmarksnumbered, pdftitle=\@title,
        pdfauthor=\@author}
\makeatother
...
\def\mnras{{Mon. Not. Roy. Astron. Soc.}}             % Monthly Notices of the RAS
